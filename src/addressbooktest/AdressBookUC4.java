...
public class AdressBookUC4 {
	...
	public void editDetails() {
		...
		for (int i = 0; i < arrayDetails.size(); i++) {
			if (arrayDetails.get(i).getFirstName().equals(confirmName)) {
				System.out.println(arrayDetails.get(i).getFirstName().equals(confirmName));
				...
				case 1:
					...
					arrayDetails.get(i).setFirstName(sc.nextLine());
					break;
				case 2:
					System.out.println("Enter Last name");
					arrayDetails.get(i).setLastName(sc.nextLine());
					break;
				case 3:
					System.out.println("Enter Address");
					arrayDetails.get(i).setAddress(sc.nextLine());
					break;
				case 4:
					System.out.println("Enter City");
					arrayDetails.get(i).setCity(sc.nextLine());
					break;
				case 5:
					System.out.println("Enter State");
					arrayDetails.get(i).setState(sc.nextLine());
					break;
				case 6:
					System.out.println("Enter Zip");
					arrayDetails.get(i).setZip(sc.nextLine());
					break;
				case 7:
					System.out.println("Enter Mobile number");
					arrayDetails.get(i).setPhoneNumber(sc.nextLine());
					break;
				case 8:
	...
	public static void main(String[] args) {
		AdressBookUC4 details = new AdressBookUC4();
		details.addDetails();
		int i = 0;
		while (i == 0) {
